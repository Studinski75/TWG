...
<# Check for SharePoint server; SQL Server; Exchange; SAGE #>
...
2025 January TEC:
+ Tweaked auto-start services to ignore new variations of 'Google Updater'
+ Fixed code to better identify installed 3rd party web browsers 
...
<# Old version of code 
$ThirdPartyBrowsers = @("Chrome", "Mozilla Firefox", "Firefox", "Mozilla", "Opera", "Microsoft Edge (Chromium)", "Sogou Explorer", "Waterfox", "DuckDuckGo", 
...
$ThirdPartyBrowsers = "Chrome|Mozilla|Firefox|\bOpera\b|Chromium|Sogou|Waterfox|DuckDuckGo|Comodo Dragon|Comodo IceDragon|QQ|Yandex|UC Browser|Baidu|Maxthon|Amigo|Netscape Navigator|Brave|Safari|Vivaldi"
$InstalledThirdPartyBrowsers = $ServersInventory | ForEach-Object { if ( $_.name -match $ThirdPartyBrowsers ) { $_ } }
if ( $InstalledThirdPartyBrowsers.Count -gt 0 )
   { Write-Output "$($SeparatorLine)3rd Party Web Browsers installed: "
     $InstalledThirdPartyBrowsers | Format-Table
...
$ServerServices = Invoke-Command -Session $ServersOnlineSessions2 -ScriptBlock { 
       ...
       $Services = $Services | Where-Object { $_.Name -ne "VSS" -and $_.Name -ne "gupdate" -and $_.Name -ne "RemoteRegistry" -and $_.Name -ne "WbioSrvc" `
                                              ...
                                              -and $_.Name -ne "BITS" -and $_.DisplayName -notlike "*Framework NGEN*" -and $_.DisplayName -notlike "Google*Update*" `
